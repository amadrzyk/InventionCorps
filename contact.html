			...
			<div class="content">
				...
				<div id="fh5co-page">
								...
								<div class="container">
									<div class="col-md-8 col-md-offset-2 col-md-push-4 js-fullheight slider-text">
										<div class="slider-text-inner">
											<div class="desc">
												<span>Find out how to get involved!</span>
												<h2>Contact Us</h2>
											</div>
										</div>
									</div>
					...
					<div id="fh5co-contact-section">
						<div class="container">
							<div class="row">
								<div class="col-md-4 col-md-offset-3 col-md-push-1 animate-box">
									<h3>Our Address</h3>
									<ul class="contact-info">
										<li><i class="icon-location-pin"></i>2530 Ridge Road, Berkeley, CA 94720</li>
										<li><i class="icon-phone2"></i>new phone who dis</li>
										<li><i class="icon-mail"></i><a href="#">club facebook page link</a></li>
										<li><i class="icon-globe2"></i><a href="#">website domain link</a></li>
									</ul>
								</div>
