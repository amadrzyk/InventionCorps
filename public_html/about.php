    ...
    <div class="container">
        ...
        <div class="row animate-box">
            <div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
                <h2>Meet Our Team</h2>
                <p>Our members come from a wide range of disciplines but share a passion for design thinking and innovation. </p>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-3 animate-box" data-animate-effect="fadeIn">
                <div class="fh5co-staff">
                    <img class="img-responsive" src="assets/images/user-1.jpg" alt="Free HTML5 Templates by freeHTML5.co">
                    <h3>James Zamora</h3>
            ...
            <div class="col-sm-3 animate-box" data-animate-effect="fadeIn">
                <div class="fh5co-staff">
                    <img class="img-responsive" src="assets/images/user-2.jpg" alt="Free HTML5 Templates by freeHTML5.co">
                    <h3>Hush Raven</h3>
            ...
            <div class="col-sm-3 animate-box" data-animate-effect="fadeIn">
                <div class="fh5co-staff">
                    <img class="img-responsive" src="assets/images/user-3.jpg" alt="Free HTML5 Templates by freeHTML5.co">
                    <h3>Alex King</h3>
            ...
            <div class="col-sm-3 animate-box" data-animate-effect="fadeIn">
                <div class="fh5co-staff">
                    <img class="img-responsive" src="assets/images/user-4.jpg" alt="Free HTML5 Templates by freeHTML5.co">
                    <h3>Hush Raven</h3>
